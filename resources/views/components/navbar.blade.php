          ...
          <div class="flex items-center">
            ...
            <div class="hidden md:block">
              <div class="ml-10 flex items-baseline space-x-4">
                ...
                <x-nav-link href="/kegiatan" :active="request()->is('kegiatan')">
                    Kegiatan
                </x-nav-link>

                <x-nav-link href="/komunitas" :active="request()->is('komunitas')">
                    Komunitas
                </x-nav-link>

                <x-nav-link href="/freelance" :active="request()->is('freelance')">
                    Freelance
                </x-nav-link>

                <x-nav-link href="/tentang" :active="request()->is('tentang')">
                    Tentang
                </x-nav-link>
      ...
      class="md:hidden" id="mobile-menu">
        <div class="space-y-1 px-2 pt-2 pb-3 sm:px-3">
          <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-gray-700 hover:text-white" -->
            ...
            <x-nav-link href="/" :active="request()->is('/')" class="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-gray-700 hover:text-white">
                    Beranda
                </x-nav-link>

                <x-nav-link href="/kegiatan" :active="request()->is('kegiatan')" class="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-gray-700 hover:text-white">
                    Kegiatan
                </x-nav-link>

                <x-nav-link href="/komunitas" :active="request()->is('komunitas')" class="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-gray-700 hover:text-white">
                    Komunitas
                </x-nav-link>

                <x-nav-link href="/freelance" :active="request()->is('freelance')" class="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-gray-700 hover:text-white">
                    Freelance
                </x-nav-link>

                <x-nav-link href="/tentang" :active="request()->is('tentang')" class="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-gray-700 hover:text-white">
                    Tentang
                </x-nav-link>
        </div>
